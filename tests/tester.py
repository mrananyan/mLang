...
if not mlang_path:
  ...
  mlang_path = os.path.expanduser ("~/engine/src.vk")
...
#  print "rm "
  print "make"
  make_cmd = '%sMLANG/tests/mlang.py -I tmp/ -o main %s 2> %s.parser_err ' % (root_path, dest, dest)
...
#REGISTER TESTS
dl_tests = get_tests_by_mask (root_path + "MLANG/tests/mlangt/*.php", ["dl"])
tests = []
