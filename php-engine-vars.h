...
#define RPC_INVOKE_MLANG_REQ 0x99a37fda
...
#define TL_MLANG_START_LEASE 0x61344739
#define TL_MLANG_LEASE_STATS 0x3013ebf4
#define TL_MLANG_STOP_LEASE 0x183bf49d
